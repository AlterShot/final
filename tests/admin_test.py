def test_admin_product_creation(admin_login, admin_page, header):
    ...
    assert admin_page.get_page_url() == admin_page_url, "URL профиля администратора неправильный"

    admin_page.add_product_button_click()
    admin_page.fill_the_blanks_item(old_item_name, old_description, old_exp_category, old_price, old_pic_url)
    ...
    admin_page.fill_the_blanks_item(new_item_name, new_description, new_exp_category, new_price, new_pic_url)
